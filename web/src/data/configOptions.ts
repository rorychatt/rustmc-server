    ...
    options: [
      {
        ...
        max: 100,
        description:
          "Maximum number of malformed or invalid packets allowed before dropping a connection.",
      },
      {
        ...
        max: 300,
        description:
          "The sliding time window in seconds during which invalid packets are accumulated.",
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        options: ["normal", "flat"],
        description:
          'Determines the world generation style. "flat" generates a flat grass plain, "normal" generates a noise-based surface.',
      },
      {
        key: "seed",
        name: "World Seed",
        ...
        defaultValue: 0,
        description:
          "Seed for random number generator utilized during normal noise terrain generation.",
      },
      {
        key: "world_dir",
        ...
        defaultValue: "world",
        description:
          "Directory path where the world state (chunks, level info) is saved and loaded.",
      },
      {
        ...
        defaultValue: 300,
        description:
          "Time interval in seconds between automatic background saving of modified chunks.",
      },
      {
        ...
        defaultValue: 3600,
        description:
          "Time interval in seconds between automatic background backups of the world directory.",
      },
      {
        key: "max_backups",
        name: "Max Backups",
