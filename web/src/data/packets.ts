...
export const PACKETS: PacketInfo[] = [
  // Status Phase
  {
    ...
    description:
      "Sent by the client immediately after handshaking to request server status metadata.",
    fields: [],
  },
  {
    id: "0x00",
    ...
    description:
      "Returns a JSON structure detailing the server version, maximum and current players, and MOTD.",
    fields: [
      {
        name: "JSON Response",
        type: "String",
        description: "Serialized JSON string conforming to Minecraft status format.",
      },
    ],
  },
  {
    ...
    fields: [
      {
        name: "Payload",
        type: "Long",
        description: "64-bit integer timestamp corresponding to the Ping Request.",
      },
    ],
  },
    ...
    fields: [
      {
        name: "Name",
        type: "String",
        description: "The player's username (maximum 16 characters).",
      },
  ...
  },
  {
    ...
    direction: "Clientbound",
    description:
      "Sent by the server to enable compression for all subsequent packet communications.",
    fields: [
      {
        name: "Threshold",
        type: "VarInt",
        description: "Packet size threshold (in bytes) above which packets are zlib-compressed.",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: "Username", type: "String", description: "The authenticated player username." },
      {
        ...
        type: "VarInt",
        description: "Number of texture profile properties.",
      },
    ],
  },
  {
    ...
    direction: "Serverbound",
    description:
      "Acknowledges receipt of Login Finished and transitions client state to Configuration.",
    fields: [],
  },
  ...
  // Configuration Phase
  {
    ...
    direction: "Clientbound",
    description:
      "Server sends list of known data/resource packs for the client to confirm sync state.",
    fields: [
      {
        name: "Packs Count",
        type: "VarInt",
        description: "Number of declared resource/data packs.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    direction: "Clientbound",
    description:
      "Transfers dimension types, biomes, chat types, and damage types registries in NBT formats.",
    fields: [
      {
        name: "Registry ID",
        type: "String",
        description: "The namespace ID of the registry (e.g. minecraft:dimension_type).",
      },
      {
        name: "Entries Count",
        type: "VarInt",
        description: "Number of elements in this registry.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    direction: "Serverbound",
    description:
      "Client acknowledges configuration completion and transitions the connection state to Play.",
    fields: [],
  },
  ...
  // Play Phase
  {
    ...
    direction: "Clientbound",
    description:
      "Initial state configuration packet entering the active gameplay world. Transmits world physics settings.",
    fields: [
      ...
      { name: "View Distance", type: "VarInt", description: "The client's chunk view distance." },
      {
        ...
        type: "VarInt",
        description: "The server's chunk ticking distance.",
      },
      {
        name: "Game Mode",
        type: "Byte",
        description: "The player's initial gamemode (Survival: 0, Creative: 1, etc.).",
      },
  ...
  },
  {
    ...
    direction: "Clientbound",
    description:
      "Transmits world voxel blocks, section structures, and lighting grids to the client.",
    fields: [
      {
        name: "Chunk X / Z",
        type: "Int",
        description: "Absolute grid coordinates of the loaded chunk.",
      },
    ],
  },
  {
    ...
    direction: "Clientbound",
    description:
      "Signals the start of a multi-chunk loading sequence, allowing the client to batch rendering.",
    fields: [],
  },
  {
    id: "0x0B",
    ...
    fields: [
      {
        name: "Batch Size",
        type: "VarInt",
        description: "Number of chunks transferred in this batch.",
      },
    ],
  },
  {
    ...
    direction: "Serverbound",
    description:
      "Sent by the client to confirm rendering and receipt of the chunk batch, throttling network throughput.",
    fields: [],
  },
  {
    id: "0x0D",
    ...
    direction: "Serverbound",
    description:
      "Sent by the client at the end of each local tick loop to trigger server update cycles.",
    fields: [],
  },
  {
    id: "0x2C",
    ...
    direction: "Serverbound",
    description:
      "Client signals that the local player has finished loading terrain and is ready for ticks.",
    fields: [],
  },
  {
    id: "0x79",
    ...
    fields: [
      {
        name: "Message",
        type: "String (JSON)",
        description: "Chat message formatted in Minecraft JSON Text component format.",
      },
    ],
  },
  {
    ...
    fields: [{ name: "Keep Alive ID", type: "Long", description: "Unique heartbeat identifier." }],
  },
  {
    id: "0x1C",
    ...
    fields: [{ name: "Keep Alive ID", type: "Long", description: "The matching identifier." }],
  },
];
